...
public enum ErrorEnum {
    ...
    BIZ_ERR_CANNOT_DELETE_USING_TOPPING_TYPE("BIZ_ERR_CANNOT_DELETE_USING_TOPPING_TYPE", "不能删除正在使用的物料类型"),
    BIZ_ERR_CANNOT_DELETE_USING_TOPPING("BIZ_ERR_CANNOT_DELETE_USING_TOPPING", "不能删除正在使用的物料"),
    BIZ_ERR_CANNOT_DELETE_USING_SPEC("BIZ_ERR_CANNOT_DELETE_USING_SPEC", "不能删除正在使用的规格"),
    BIZ_ERR_CANNOT_DELETE_USING_TEA_TYPE("BIZ_ERR_CANNOT_DELETE_USING_TEA_TYPE", "不能删除正在使用的茶品类型"),
