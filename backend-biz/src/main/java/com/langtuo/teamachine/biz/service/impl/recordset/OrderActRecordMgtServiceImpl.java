...
import com.langtuo.teamachine.api.model.recordset.OrderSpecItemActRecordDTO;
import com.langtuo.teamachine.api.model.recordset.OrderToppingActRecordDTO;
...
import com.langtuo.teamachine.dao.accessor.recordset.OrderActRecordAccessor;
import com.langtuo.teamachine.dao.accessor.recordset.OrderSpecItemActRecordAccessor;
import com.langtuo.teamachine.dao.accessor.recordset.OrderToppingActRecordAccessor;
...
public class OrderActRecordMgtServiceImpl implements OrderActRecordMgtService {
    ...
    private OrderSpecItemActRecordDTO convert(OrderSpecItemActRecordPO po) {
        ...
        SpecItemPO specItemPO = specItemAccessor.selectOneByCode(po.getTenantCode(), po.getSpecItemCode());
