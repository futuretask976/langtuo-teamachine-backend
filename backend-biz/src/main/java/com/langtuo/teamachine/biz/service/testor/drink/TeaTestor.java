...
//                } else if (BizConsts.TITLE_STEP_INDEX.equals(cell.getStringCellValue())) {
//                    titleColumnIndexMap.put(BizConsts.TITLE_STEP_INDEX, i);
//                } else if (BizConsts.TITLE_TOPPING_CODE.equals(cell.getStringCellValue())) {
//                    titleColumnIndexMap.put(BizConsts.TITLE_TOPPING_CODE, i);
...
//                } else if (BizConsts.TITLE_ACTUAL_AMOUNT.equals(cell.getStringCellValue())) {
//                    titleColumnIndexMap.put(BizConsts.TITLE_ACTUAL_AMOUNT, i);
//                }
//            }
//
...
//                }
//
//                Cell cell4AdjustStepIndex = row.getCell(titleColumnIndexMap.get(BizConsts.TITLE_STEP_INDEX));
//                int adjustStepIndex = Double.valueOf(cell4AdjustStepIndex.getNumericCellValue()).intValue();
//
//                Cell cell4AdjustToppingCode = row.getCell(titleColumnIndexMap.get(BizConsts.TITLE_TOPPING_CODE));
...
//
//                Cell cell4AdjustAmount = row.getCell(titleColumnIndexMap.get(BizConsts.TITLE_ACTUAL_AMOUNT));
